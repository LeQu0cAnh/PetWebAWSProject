...
const MEMBERS = [
  {
    name: 'Lê Quốc Anh',
    role: 'Co-Founder / Core Backend Architect',
    description: 'Chịu trách nhiệm kiến trúc hệ thống, đồng bộ dữ liệu Cognito và vận hành cơ sở dữ liệu.',
    initial: 'QA',
  ...
  },
  {
    ...
    description: 'Xây dựng giao diện ứng dụng, tích hợp APIs, tối ưu hóa trải nghiệm người dùng.',
    initial: 'TL',
    color: '#dab9ff', // Neon Purple
  },
  {
    name: 'Vũ Thị Thanh Thảo',
    role: 'Content Strategist / Quality Assurance',
    description: 'Kiểm thử chất lượng phần mềm, quản lý nội dung cộng đồng và kiểm duyệt bài viết.',
    initial: 'TT',
    color: '#d4a017', // Gold
  },
  {
    ...
    description: 'Quản trị hạ tầng đám mây S3, cấu hình Docker và triển khai hệ thống VPS/Domain.',
    initial: 'QD',
    color: '#ef4444', // Red
  },
  {
    name: 'Bạch Thế Bình',
    role: 'Product Designer / Game Balance',
    description: 'Thiết kế giao diện Chronos Shard, cân bằng hệ thống Gamification và mốc EXP.',
    initial: 'TB',
    color: '#3b82f6', // Blue
  },
];
      ...
      <div className="page-content relative z-10">
        ...
        <div className="relative mb-12">
          ...
          <div className="text-[9px] text-outline opacity-70 leading-normal mt-1">
            // HỒ SƠ NHÂN SỰ VÀ CỔNG THÔNG TIN ỦNG HỘ DỰ ÁN PETWEB
          </div>
            ...
            <div className="lg:col-span-7 card p-8 border-4 border-black hard-shadow-tertiary flex flex-col justify-between">
              <div>
                ...
                <p className="font-body-lg text-sm sm:text-base text-on-surface-variant leading-relaxed mb-6">
                  Dự án PetWeb được phát triển hoàn toàn phi lợi nhuận. Sự đóng góp của các bạn sẽ giúp chúng tôi duy trì máy chủ, tối ưu hóa các API hỗ trợ AI và nâng cấp trải nghiệm Desktop Pet. Mọi đóng góp dù lớn hay nhỏ đều là nguồn động lực to lớn cho đội ngũ!
                </p>
