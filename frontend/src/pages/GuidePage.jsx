...
const GUIDE_STEPS = [
  {
    ...
    desc: 'Nhấn giữ chuột trái để di chuyển và thả AI Assistant ở bất kỳ đâu trên màn hình. Nhấn chuột phải để mở menu cài đặt nhanh.',
    color: '#f0bb35',
  },
  {
    step: '02',
    ...
    title: 'Trò Chuyện AI',
    desc: 'Nhấp đúp chuột (Double-click) vào AI Assistant để mở hộp chatbox. Bạn có thể đặt câu hỏi hoặc yêu cầu tóm tắt tài liệu.',
    color: '#17deca',
  },
  {
    step: '03',
    ...
    desc: 'Bật tính năng "Focus Mode" trong cài đặt. AI Assistant sẽ nhẹ nhàng nhắc nhở bạn uống nước và vận động sau mỗi 45 phút.',
    color: '#dab9ff',
  },
];
    ...
    <div className="page-content pt-20 pb-24 font-label-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-start">
        ...
        <div className="lg:col-span-5 card p-6 border-2 border-black flex flex-col justify-between h-[360px]">
          ...
          <p className="font-body-md text-on-surface-variant text-[11px] italic mt-4 leading-tight">
            "Hành trình đồng hành cùng AI Assistant, thăng tiến sức mạnh hạt nhân."
          </p>
        </div>
      </div>
      <div className="h-5 pointer-events-none"></div>
      ...
      <div className="card p-8 border-2 border-black mb-16">
        ...
        <p className="font-body-md text-on-surface-variant text-sm mb-6">
          Bạn có thể ra lệnh trực tiếp cho AI Assistant bằng cách gõ vào khung chat các lệnh điều khiển hệ thống sau:
        </p>
