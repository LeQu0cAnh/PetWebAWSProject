 ...
 * scripts/seed.js
 *
 * Seed dữ liệu mặc định cho SystemConfig vào DynamoDB.
 * Chạy: node scripts/seed.js
 */

require('dotenv').config();

const { upsertConfig } = require('../src/db/db');
...
async function main() {
  console.log('🌱 Seeding SystemConfig vào DynamoDB...');
  ...
  console.log(`\n✅ Seeded ${defaultConfigs.length} system configs thành công!`);
}
